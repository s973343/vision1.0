...
def infer_task_name(entry, default="vista400k"):
...
def parse_args():
    parser = argparse.ArgumentParser(description="Batch VISTA-400K ingestion runner")
    parser.add_argument("--root", default="data/VISTA-400K", help="VISTA-400K root folder")
    ...
    parser.add_argument("--frames-root", default="data/frames/vista400k", help="Root for extracted frames")
    parser.add_argument("--audio-root", default="data/audio/vista400k", help="Root for extracted audio")
    ...
    parser.add_argument("--hf-dataset", default="TIGER-Lab/VISTA-400K", help="HF dataset name")
    ...
    parser.add_argument("--cache-dir", default="data/cache/vista400k", help="Cache for streamed videos")
